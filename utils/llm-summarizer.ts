...
2. **SEO推奨事項（seo_recommendations、300-400文字）:**
   - AnalyticsとSearch Consoleのデータを基に、具体的な推奨事項を記載
   - どのキーワードをメインキーワードとして狙うべきか（Search Consoleのデータから具体的な数値と共に）
   - 過去の人気記事の傾向を踏まえた記事構成の推奨（Analyticsのデータから具体的な数値と共に）
   - タイトルや見出しに含めるべきキーワード
   - 記事の長さや構成の推奨（過去の人気記事の傾向から具体的な数値と共に）
   - 関連キーワードの組み合わせ方
   - 検索意図に合わせた記事の方針
